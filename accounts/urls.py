...
urlpatterns = [
    ...
    path('bilim-baholash/<int:pk>/toxtatish/', AssessmentStopView.as_view(), name='assessment-stop'),
    ...
    path('yoriknomalar-statistikasi/', GuidelineAnalyticsView.as_view(), name='guideline-analytics'),
    ...
    path('ichki-yoriknomalar/<int:pk>/stop/', SectionInternalGuidelineStopView.as_view(), name='internal-guideline-stop'),
    ...
    path('ish-amaliyotlari/<int:pk>/ustoz-qabul/', SectionWorkPracticeResponsibleAcceptView.as_view(), name='work-practice-responsible-accept'),
